        ...
        <div className='flex grow content'>
          <div className="container  mx-auto py-8 flex flex-col gap-12 md:flex-row justify-center items-center px-4">
            ...
            <div className=" basis-1/2 text-center md:text-left pb-4 md:pb-0">
              ...
              <p className={`${timer ? 'opacity-100 translate-x-0' : '-translate-x-20'} text-6xl font-bold opacity-0 pb-2 transition-all duration-[1000ms]`}> Vijay </p>
              <p className={`${timer ? 'opacity-100 -translate-y-0' : 'opacity-0 translate-y-20 '} text-2xl font-semibold transition-all duration-700`}>And I am a <span className='text-cyan-300'>{displayText}</span></p>
              <p className={`${timer ? 'opacity-100 -translate-y-0' : 'opacity-0 translate-y-20'} text-gray-300 text-base  transition-all duration-[1000ms]`}> I&rsquo;m a passionate learner, eager to explore and grow in the world of web development. I&rsquo;m currently building my skills in <span className='text-cyan-300 font-bold'>React.js</span>, <span className='text-cyan-300 font-bold'>Next.js</span>, and other technologies, with a focus on website design and frontend development</p>
              <div className={`flex justify-center md:justify-start icons cursor-pointer gap-2 text-gray-400 py-4`}>

                <a className={`facebook transition-transform hover:scale-125`} href='https://www.facebook.com/vijay.nagavelu/'>
                ...
                <a className={`twitter transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-32'}  transition-all duration-[1400ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M22 4.01c-1 .49 -1.98 .689 -3 .99c-1.121 -1.265 -2.783 -1.335 -4.38 -.737s-2.643 2.06 -2.62 3.737v1c-3.245 .083 -6.135 -1.395 -8 -4c0 0 -4.182 7.433 4 11c-1.872 1.247 -3.739 2.088 -6 2c3.308 1.803 6.913 2.423 10.034 1.517c3.58 -1.04 6.522 -3.723 7.651 -7.742a13.84 13.84 0 0 0 .497 -3.753c0 -.249 1.51 -2.772 1.818 -4.013z"></path>
                  </svg>
                </a>

                <a className={`linkedIn transition-transform hover:scale-125`} href='https://www.linkedin.com/in/vijay-nagavelu-59101318b/'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-52'}  transition-all duration-[1600ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <div className=" md:basis-[28%] relative  md:p-0">
              <div className='flex'>
                {/* Your Picture */}
                <Image src={picture} alt="Your Picture" className="backLight  rounded-full mx-auto relative z-10" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container  mx-auto py-8 flex flex-col gap-36 md:flex-row justify-center items-center px-4">
            ...
            <div className=" basis-1/2 text-center md:text-left pb-4 md:pb-0">
              ...
              <p className="text-gray-200 text-base pb-4">
                Hey, I&rsquo;m Vijay, a frontend enthusiast diving into web development. I&rsquo;m passionate about <span className='text-cyan-300 font-bold'>React.js</span>, <span className='text-cyan-300 font-bold'>Next.js</span>, and <span className='text-cyan-300 font-bold'>Tailwind CSS</span> for captivating design.<span className='text-cyan-300 font-bold'>JavaScript</span>  powers my interactivity, and <span className='text-cyan-300 font-bold'>HTML/CSS</span> set the stage. I also explore REST APIs to fetch data from the digital realm. Join me on my journey to become a frontend maestro crafting captivating web experiences. 🚀💡💻 #WebDev #FutureFrontendPro
              </p>
        ...
        <div className='flex flex-col gap-12 md:gap-0 grow justify-around'>
          ...
          <section className="container mx-auto py-0 flex flex-col gap-12 md:flex-row justify-center items-center px-4">
            <div className="basis-1/3  hover:scale-[1.05] scale-[1]  relative  md:p-0 transition-all duration-500 ease-in-out">
              ...
              <div className='flex items-center pt-2 w-full justify-around'>
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu/whats-up-clone'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path>
                  </svg>
                ...
                <a className={`link transition-transform hover:scale-125`} href='https://vhatsup-app.netlify.app/'>
            ...
            <div className="basis-1/3  hover:scale-[1.05] scale-[1]  relative  md:p-0 transition-all duration-500 ease-in-out">
              ...
              <div className='flex items-center pt-2 w-full justify-around'>
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu/cash-app'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path>
                  </svg>
                ...
                <a className={`link transition-transform hover:scale-125`} href='https://cash-app-vijaynagavelu.vercel.app/'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path>
                    <path d="M11 13l9 -9"></path>
            ...
            <div className="basis-1/3  hover:scale-[1.05] scale-[1] relative md:p-0 transition-all duration-500 ease-in-out">
              ...
              <div className='flex items-center pt-2 w-full justify-around'>
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu/budget-app'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path>
                  </svg>
                ...
                <a className={`link transition-transform hover:scale-125`} href='https://budget-app-vijaynagavelu.vercel.app/dashboard'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path>
                    <path d="M11 13l9 -9"></path>
          ...
          <section className="container mx-auto py-0 flex flex-col gap-12 md:flex-row justify-center items-center px-4">
            <div className="basis-1/3  hover:scale-[1.05] scale-[1]  relative  md:p-0 transition-all duration-500 ease-in-out">
              ...
              <div className='flex items-center pt-2 w-full justify-around'>
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu/swiggy-clone'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path>
                  </svg>
                ...
                <a className={`link transition-transform hover:scale-125`} href='https://hotel-abb.netlify.app/'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path>
                    <path d="M11 13l9 -9"></path>
            ...
            <div className="basis-1/3  hover:scale-[1.05] scale-[1]  relative  md:p-0 transition-all duration-500 ease-in-out">
              ...
              <div className='flex items-center pt-2 w-full justify-around'>
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu/movies-app'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path>
                  </svg>
                ...
                <a className={`link transition-transform hover:scale-125`} href='https://movies-abb.netlify.app/'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path>
                    <path d="M11 13l9 -9"></path>
            ...
            <div className="basis-1/3  hover:scale-[1.05] scale-[1]  relative  md:p-0 transition-all duration-500 ease-in-out">
              ...
              <div className='flex items-center pt-2 w-full justify-around'>
                <a className={`github transition-transform hover:scale-125`} href='https://github.com/vijaynagavelu/todo-app'>
                  <svg xmlns="http://www.w3.org/2000/svg" className={`${timer ? 'opacity-100 -translate-x-0 ' : 'translate-x-72'}  transition-all duration-[1800ms] opacity-0`} width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="cyan" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"></path>
                  </svg>
                ...
                <a className={`link transition-transform hover:scale-125`} href='https://todo-apb.netlify.app/'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6"></path>
                    <path d="M11 13l9 -9"></path>
          ...
          <div className="container mx-auto py-8 flex flex-col gap-12 md:flex-row justify-center items-center px-4">
            ...
            <div className=" basis-1/2 text-center md:text-left pb-4 md:pb-0">
              ...
              <div className="flex justify-center md:justify-start icons cursor-pointer gap-2 text-gray-400 py-4">
                ...
                <a className='twitter transition-transform hover:scale-125 ' href='https://twitter.com/VijayNagavelu'>
